...
async function getCommonQuest() {
    ...
    if (chosenKey=="regionalElite4") {
        let selectedMon = await getBasicPokemon()
        questString = 'DEFEAT the Elite Four using only pokemon from <a href="https://www.serebii.net/pokemon/gen'+selectedMon.Generation+'pokemon.shtml">gen '+ selectedMon.Generation + '</a>.'
        questType = 'battle'
    }
